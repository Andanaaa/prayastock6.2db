...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  const menuItems = [
    {
      ...
      title: 'Daftar Stock',
      description: 'Lihat dan kelola semua stock barang',
      path: '/stock',
    },
    {
      icon: <PackagePlus size={20} />,
      title: 'Tambah Barang',
      description: 'Tambah barang baru ke inventory',
      path: '/add',
    },
    {
      icon: <PackageCheck size={20} />,
      title: 'Barang Masuk',
      description: 'Catat barang yang baru masuk',
      path: '/in',
    },
    {
    ...
    },
    {
      ...
      title: 'Penjualan',
      description: 'Catat barang keluar dan penjualan',
      path: '/sales',
    },
    {
      icon: <Share2 size={20} />,
  ...
  return (
    <div
      ...
      } fixed lg:relative lg:translate-x-0 z-30 transition-transform duration-300 ease-in-out bg-white border-r border-gray-200 w-72 min-h-screen`}
    >
      <div className="p-6">
